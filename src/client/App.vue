<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="btm-nav z-50 bg-base-200 border-t border-base-300 md:hidden">
      ...
      <button @click="moreMenuOpen = !moreMenuOpen" class="relative">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
          <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        </svg>
        <span class="btm-nav-label text-xs">More</span>
        <ul v-if="moreMenuOpen" class="absolute bottom-full right-0 mb-2 menu p-2 shadow-lg bg-base-200 rounded-box w-52">
